...
export interface CertificateResult {
  ...
  hostnameMatches: boolean; validFrom?: Date; expiresAt?: Date; daysRemaining?: number; remainingMs?: number;
  ...
  connectHost: string; resolvedIp?: string; sniHostname: string; durationMs: number; status: CertificateStatus;
